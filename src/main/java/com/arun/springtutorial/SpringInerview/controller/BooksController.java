...
import com.arun.springtutorial.SpringInerview.service.BookInterfaceService;
...
public class BooksController {
	...
	public ResponseEntity<List<Books>> getAllBooks() {
		List<Books> books = bookInterfaceService.getAllBooks();
	...
	public ResponseEntity<Books> getABook(@PathVariable final long id) {
		Books book = bookInterfaceService.getABook(id);
	...
	public ResponseEntity<Long> createABook(@RequestBody Books book) {
		...
		long primaryKey = bookInterfaceService.createABook(book);
